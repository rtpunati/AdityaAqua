...
<div class="page">
    ...
    <nav id="menu-1" class="mega-menu fa-change-black" data-color=""> 
        <section class="menu-list-items"> 
           <ul class="menu-logo">
                <li> <a href="index.php"> <img src="<?= "assets/logo/".$details['logo']?>" alt="logo" class="img-responsive" width="80" height="50"> </a> </li>
            </ul>
            <ul class="menu-links pull-right">
			<li> <a href="index.php"> <i class="fa fa-home fa-indicator"></i>  <?= $home['page_title']; ?></a></li>
			<li> <a href="Career-Guidance1/templates/hometest copy.html"> <i class="fa fa-home fa-indicator"></i>  Career prediction</a></li>
